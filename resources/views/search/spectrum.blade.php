...
@section('scripts')
    ...
    <script src="{{ asset('js/svg_to_pdf.js') }}"></script>
                ...
                <div class="row">
                    <div class="col-xs-12 text-center">
                        <button id="btnPrint" class="btn btn-danger" onclick="window.print()">
                            <i class="fa fa-btn fa-user"></i>{{ trans('applicationResource.menu.print') }}
                        </button>
                        <button class="btn btn-danger" onclick="window.history.back()">
                            <i class="fa fa-btn fa-user"></i>{{ trans('applicationResource.button.back') }}
                        </button>
                    </div>
                </div>
