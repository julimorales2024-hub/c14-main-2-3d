d3.parcoords = function(config) {
  var __ = {
    ...
    width: 600,
    height: 100,
    margin: { top: 24, right: 5, bottom: 12, left: 5 },
    nullValueSeparator: "undefined", // set to "top" or "bottom"
    nullValueSeparatorPadding: { top: 8, right: 5, bottom: 8, left: 5 },
    color: "#069",
  ...
  g.append("svg:g")
    ...
    .append("svg:text")
      ...
      .attr({
        "text-anchor": "middle",
        "y": 0,
        "transform": "translate(-5,-5) rotate(" + __.dimensionTitleRotation + ")",
        "x": 0,
        "class": "label"
      })
