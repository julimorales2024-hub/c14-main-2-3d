...
(function ($) {
  ...
  function SlickGrid(container, data, columns, options) {
    ...
    function finishInitialization() {
      if (!initialized) {
        ...
        $headerScroller
            ...
            .delegate(".slick-header-column", "click", handleHeaderClick)
    ...
    function appendRowHtml(stringArray, row, range) {
      ...
      stringArray.push("<div id='"+row+"' class='ui-widget-content " + rowCss + "' style='top:" + (options.rowHeight * row - offset) + "px'>");
    ...
    function appendCellHtml(stringArray, row, cell, colspan) {
      ...
      stringArray.push("<div id='"+row+"' class='" + cellCss + "'>");
    ...
    //////////////////----------------------------------------------------------------------------
    ///-------------------------------------------------------------------------------------------
    ///                       FUNCIONALIDAD DE PULSAR EL RATON ONCLICK
    /// ------------------------------------------------------------------------------------------
    function handleClick(e) {
      auxdata=new Array();
     // alert(typeof capas[i]);
     // 
     // 
     //alert(e.target.css)
     //alert(e.target.col+"jplala");
     var num=this.id;
      if(typeof capas[0] == "undefined"){
        capas.push(-1);
      }
      sw=false;
      for (var i in capas) {
        if(capas[i]==e.target.id){
          capas.splice(i,i);
          $( "div" ).remove( "#molecula"+e.target.id );
          $( "table" ).remove( "#t"+e.target.id );
      ...
      if(sw==false){
          $("#"+e.target.id).css("color", ""+colores[e.target.id]+"");
          console.log("libreeria"+colores[e.target.id]);
          capas.push(e.target.id);
           // Obtener la referencia del elemento body
          var tablas = document.getElementById("tablas");
         
          // Crea un elemento <table> y un elemento <tbody>
          var tabla   = document.createElement("table");
          tabla.id="t"+e.target.id;
          ...
          for (var i = 0; i < 6; i++) {
            ...
            hilera.style.backgroundColor = colores[e.target.id];
            ...
            for (var j = 0; j < 2; j++) {
              ...
              if(j==1){
                switch(i){
                  case 0:
                    var textoCelda = document.createTextNode(dataSecundario2[num].nombre);
                    break;
                  case 1:
                    var textoCelda = document.createTextNode(dataSecundario2[num].familia);
                    break;
                  case 2:
                    var textoCelda = document.createTextNode(dataSecundario2[num].tipo);
                    break;
                  case 3:
                    var textoCelda = document.createTextNode(dataSecundario2[num].disolvente);
                    break;
                  case 4:
                    var textoCelda = document.createTextNode(dataSecundario2[num].disolvente);
                    break;
                  case 5:
                    var textoCelda = document.createTextNode(dataSecundario2[num].formula);
                    break;
                ...
                switch(i){
                  case 0:
                    ...
                    break;
                  case 1:
                    var textoCelda = document.createTextNode("Familia");
                    break;
                  case 2:
                  ...
                  case 3:
                    ...
                    break;
                  case 4:
                    var textoCelda = document.createTextNode("Disolvente");
                    break;
                  case 5:
                    var textoCelda = document.createTextNode("Formula");
                    break;
                }
          ...
          tabla.setAttribute("border", "2", "black");

          
          
          var padre=document.getElementById("cuerpo");
              var hijo=document.createElement("div");
              hijo.style.float="left";
              hijo.id="molecula"+e.target.id;
              padre.appendChild(hijo);
              jme=dataSecundario2[num].jme;

             longitud=graficas3.length;
              console.log(longitud)

              for (var i=0 ; i < longitud-1; i++) {
                auxdata[i]=[[parseInt(graficas3[i].CH3),parseFloat(graficas3[i+1].CH3)]];
              };
              console.log(graficas3.length);
              console.log(auxdata);
             
            for (var i = 0; i < longitud-1; i++) {
              chart.series[0].data[i].update([parseInt(graficas3[i].CH3),parseFloat(graficas3[i+1].CH3)]);
            };
          ...
          jsmeApplet = new JSApplet.JSME("molecula"+e.target.id, "150px", "100px", {
              "options" : "depict"
              });
    ...
    //////////////////----------------------------------------------------------------------------
    ///-------------------------------------------------------------------------------------------
    ///                       FUNCIONALIDAD DE PASAR EL RATON POR ENCIMA HOVER
    /// ------------------------------------------------------------------------------------------
    ...
    function handleMouseEnter(e) {
      ...
      jsmeApplet = new JSApplet.JSME("molecula", "150px", "100px", {
          "options" : "depict"
          });
          jsmeApplet.readMolecule(jme);
